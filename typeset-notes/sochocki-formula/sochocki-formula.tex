...
In particular we note that the principal value operator $\mathcal{P}$ is only meaningful when it acts on some integral.

We choose the minus sign in the expression $1/(x-i\eta)$ because it is equal to
 \[
\frac{x+i\eta}{x^{2}+\eta^{2}}
 \]
where the numerator has a nice form.
