...
\begin{rem}
    ...
    Let us focus on the Bosonic / Fermionic states ``constructed'' by $\mathcal{P}$ first,
    ...
    If $\ket{\psi}$ is a \emph{generic} $+1$ eigenstate of $\mathcal{P}$, then
    we want to write it
