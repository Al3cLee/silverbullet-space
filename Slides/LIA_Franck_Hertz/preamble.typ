...
#let img = math.op("img", limits: true)
...
#let template-touying(doc) = [
  ...
  #show: metropolis-theme.with(
    ...
    aspect-ratio: "4-3",
    config-info(
      title: par(text(size: 1.5em)[Frank-Hertz via Lock-in Amps]),
      subtitle: [Poisson vs. Time-dependent inhomogeneous Poisson Processes],
